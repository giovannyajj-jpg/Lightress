...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Verificar si el correo ya existe en la web
    ...
    // Configuración de la API de Pterodactyl con tus datos
    $ptero_url = "https://panel.deltanodes.xyz"; 
    $ptero_api_key = "ptla_K3XcMnHU9Sya2VULrxP5RUOoTCNeBFEvyZjR3tHV1vN";
    ...
    if ($http_code == 201) {
        ...
        // Guardar el usuario en la base de datos web vinculando su ID de Pterodactyl
        ...
        $error_msg = isset($ptero_response['errors'][0]['detail']) ? $ptero_response['errors'][0]['detail'] : 'Error al conectar con Pterodactyl';
        echo "<script>alert('Error: " . addslashes($error_msg) . "'); window.location.href='index.php';</script>";
    }
}
?>
